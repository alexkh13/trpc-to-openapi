...
const getOpenApiPathsObject = (appRouter, securitySchemeNames, filter) => {
    ...
    (0, utils_1.forEachOpenApiProcedure)(procedures, ({ path: procedurePath, type, procedure, meta }) => {
        ...
        try {
            ...
            const { openapi } = meta;
            const { method, summary, description, tags, requestHeaders, responseHeaders, successDescription, errorResponses, protect = true, } = meta.openapi;
            ...
            const inputSchema = (0, utils_1.unwrapZodType)(inputParser, true).meta(Object.assign(Object.assign({}, ((o === null || o === void 0 ? void 0 : o.title) ? { title: o === null || o === void 0 ? void 0 : o.title } : {})), ((o === null || o === void 0 ? void 0 : o.description) ? { description: o === null || o === void 0 ? void 0 : o.description } : {})));
            const requestData = {};
            if (!(pathParameters.length === 0 && (0, utils_1.instanceofZodTypeLikeVoid)(inputSchema))) {
                ...
                if ((0, utils_1.acceptsRequestBody)(method)) {
                    ...
                    requestData.requestParams =
                        (_c = (0, schema_1.getParameterObjects)(inputSchema, isInputRequired, pathParameters, requestHeaders, 'path')) !== null && _c !== void 0 ? _c : {};
                }
                else {
                    requestData.requestParams =
                        (_d = (0, schema_1.getParameterObjects)(inputSchema, isInputRequired, pathParameters, requestHeaders, 'all')) !== null && _d !== void 0 ? _d : {};
                }
            }
